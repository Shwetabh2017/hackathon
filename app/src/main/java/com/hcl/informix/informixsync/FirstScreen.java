...
public class FirstScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etDbname = findViewById(R.id.dbname);
        //
    ...
    public void senddatatoserver() {
        ...
        try {
            post_dict.put("name", etDbname.getText().toString());
...
// Set/Store data
            edit.putString("dbname", etDbname.getText().toString());

// Commit the changes
            edit.apply();
            Intent intent = new Intent(FirstScreen.this, SecondScreen.class);
            intent.putExtra("dbname", etDbname.getText().toString());
